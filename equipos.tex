...
\begin{center}
	...
	\captionof{figure}{Una pequeña carga de prueba positiva $q_0$ colocada en el punto P cerca de un objeto con una carga positiva $Q$ mucho mayor experimenta un campo eléctrico E en el punto P establecido por la carga fuente $Q$.}
\label{fig:campo}
\end{center}
